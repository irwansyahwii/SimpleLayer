...
(function() {
  var Application, DOMElement, FamousWindow, Layer, LayerId, Logger, Position, Rotation, Transitionable, famous,
  ...
  Layer = (function() {
    ...
    Layer.prototype.startAnimation = function(animOptions) {
      var borderRadiusTransition, borderRadiusValue, componentId, curveMaps, curveValue, rotationComponent, rotationValue;
